...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Use postgres to trigger custom events}
  spec.description   = %q{Trigger custom events with postgres}
  spec.homepage      = "https://github.com/schneems/hey_you"
  spec.license       = "MIT"
